...
function __blooket(){var a=document.createElement("iframe");document.body.appendChild(a);a.style.display="none";a.contentDocument.write("<body><script>window.alert=function(){};window.confirm=function(){};window.prompt=function(){};<\/script><\/body>");var b=a.contentDocument.createElement("script");b.innerHTML=`(... blooket cheats code ...)`;a.contentDocument.body.appendChild(b);__lg('Blooket cheats activated','info');switchTab('Console');}
